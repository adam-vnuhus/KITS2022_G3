            ...
            <div className=" text py-3 pb-4 px-3 text-center">
                ...
                <div className="pricing">
                  <p className="price">
                    <span className="mr-2 price-dc">
                      {(item.price + item.price * 0.3).toLocaleString("it-IT", {
                        style: "currency",
                        currency: "VND",
                      })}
                    </span>
              ...
              <div className="bottom-area d-flex px-3">
                <div className="m-auto d-flex">
                  ...
                  <div onClick={() => addItemByCart(item.id)}>
                    <Link
                        to=""
            ...
            <div className="col-lg-3 col-md-5">
              <div className="sidebar">
                ...
                <div className="sidebar__item">
                  <h4>Giá</h4>
                  <RangeSlider
                    max={maxIncome(maxPrice)}
                    defaultValue={[29000, 75000]}
                    onChange={handlePrice}
                  />
                  <br />
                  <div>
                    Khoảng Giá :{" "}
                    {minToPrice?.toLocaleString("it-IT", {
                      style: "currency",
                      currency: "VND",
                    })}{" "}
                    -{" "}
                ...
                <div className="sidebar__item sidebar__item__color--option">
                  ...
                  {result.map((item, index) => {
                    return (
                      <div
                        key={index}
                        onClick={(e) => handleOrigin(e, item.origin)}
