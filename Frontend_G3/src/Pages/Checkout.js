                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-12 col-md-6">
                                <div className="checkout__order">
                                    ...
                                    <div className="checkout__order__subtotal">Phí vận chuyển <span>{cartTotal > 0 ? (20.000) : (0).toLocaleString('it-IT', { style: 'currency', currency: 'VND' })}</span></div>
                                    ...
                                    <div className="checkout__order__subtotal">Tổng tiền <span>{cartTotal > 0 ? (cartTotal + cartTotal / 10 + 20000)/1000 : (0).toLocaleString('it-IT', { style: 'currency', currency: 'VND' })} </span></div>
