...
export default function SignIn({ onLogin }) {
  ...
  const handleLogin = async (e) => {
    ...
    loginUser({
      ...
      async () => {
        ...
        else window.location.replace(`${state}`);
      },
  ...
  const handleRegister = async (e) => {
    ...
    await registerUser({
      ...
      () => window.alert("Kiểm tra mail để xác thực"),
      () =>
        window.alert(
          "Đăng ký thất bại, vui lòng nhập email khác hoặc thử lại sau"
        )
    );
  };
  ...
  function SwitchHandler() {
    isHidden === `${styles["is-hidden"]}`
      ? SetHidden("")
      : SetHidden(`${styles["is-hidden"]}`);
    isNotHidden === ""
      ? SetNotHidden(`${styles["is-hidden"]}`)
      : SetNotHidden("");
    isTxr === `${styles["is-txr"]}`
      ? SetTxr("")
      : SetTxr(`${styles["is-txr"]}`);
    isTxl === `${styles["is-txl"]}`
      ? SetTxl("")
      : SetTxl(`${styles["is-txl"]}`);
    isZ200 === `${styles["is-z200"]}`
      ? SetZ200("")
      : SetZ200(`${styles["is-z200"]}`);
    SetGx(`${styles["is-gx"]}`);
    ...
    <>
      <div
        ...
        style={{
          backgroundImage:
            "url(" +
            "https://wallpaperforu.com/wp-content/uploads/2020/10/food-wallpaper-20100313212461920x1200.jpg" +
            ")",
      ...
      >
        <div className={`${styles["main"]} ${styles["opacity"]}`}>
          <div
            className={`${styles["container"]} ${styles["a-container"]} ${isTxl}`}
            id={styles["a-container"]}
          >
            <form
            ...
            >
              ...
              />
              <button
                className={`${styles["form__button"]} ${styles["button"]} ${styles["button"]}`}
                type="submit"
              >
                Đăng ký
              </button>
          ...
          <div
            className={`${styles["container"]} ${styles["b-container"]} ${isTxl} ${isZ200}`}
          ...
          <div
            className={`${styles["switch"]} ${isTxr} ${isGx}`}
            id={styles["switch-cnt"]}
          >
            <div className={`${styles["switch__circle"]} ${isTxr}`} />
            <div
              className={`${styles["switch__circle"]} ${styles["switch__circle--t"]} ${isTxr}`}
            />
            <div
              className={`${styles["switch__container"]} ${isHidden}`}
              id={styles["switch-c1"]}
            >
              <h2 className={`${styles["switch__title"]} ${styles["title"]}`}>
                Chào mừng bạn đến với chúng tôi !
              </h2>
              <p className={styles["switch__description description"]}>
                Vui lòng nhập thông tin cá nhân của bạn
              </p>
              <button
                className={`${styles["switch__button"]} ${styles["button"]} ${styles["switch-btn"]}`}
            ...
            <div
              className={`${styles["switch__container"]} ${isNotHidden}`}
              id={styles["switch-c2"]}
            >
              <h2 className={`${styles["switch__title"]} ${styles["title"]}`}>
                Chào Mừng Bạn !
