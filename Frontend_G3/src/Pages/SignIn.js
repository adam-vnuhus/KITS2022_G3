            ...
            <div className={`${styles["main"]} ${styles["opacity"]}`}>
                ...
                <div className={`${styles["container"]} ${styles["b-container"]} ${isTxl} ${isZ200}`}
                    ...
                    <form className={styles["form"]} id={styles["b-form"]} onSubmit={handleLogin}>
                        ...
                        <input className={styles["form__input"]} type="password" placeholder="Password" name='password'
                ...
                <div className={`${styles["switch"]} ${isTxr} ${isGx}`} id={styles["switch-cnt"]}>
                    ...
                    <div className={`${styles["switch__container"]} ${isHidden}`} id={styles["switch-c1"]}>
                        ...
                        <p className={styles["switch__description description"]}>To keep connected with us please login
                    ...
                    <div className={`${styles["switch__container"]} ${isNotHidden}`} id={styles["switch-c2"]}>
                        ...
                        <p className={`${styles["switch__description"]} ${styles["description"]}`}>Enter your personal
                            details and start journey with us</p>
                        <button className={`${styles["switch__button"]} ${styles["button"]} ${styles["switch-btn"]}`}
                                onClick={SwitchHandler}>SIGN UP
                        </button>
                    </div>
                </div>
            </div>
